...
import DeveloperCard from '../property/DeveloperCard';
    ...
    <section className="bg-white py-16 sm:py-20 lg:py-24">
      <div className="max-w-[1280px] mx-auto px-5 md:px-8 lg:px-12">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-10 lg:mb-12">
          <SectionHeader
            eyebrow="Developers"
            title="Projects from trusted developers."
            subtitle="Explore new launches and ready-to-move projects from verified builders."
          />
          <Link
            to="/developers"
