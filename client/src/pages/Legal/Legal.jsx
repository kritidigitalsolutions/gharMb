  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-slate-800 tracking-tight">Legal Documents</h2>
          <p className="text-xs text-slate-500 mt-1">Update Terms of Service and Privacy Policy content.</p>
        </div>
        <button
          onClick={handleSave}
          disabled={isSaving}
        ...
        <div className="flex gap-8">
          <button
            ...
            className={`pb-3 text-sm font-bold transition-all relative ${
              activeTab === 'terms' ? 'text-brand' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Terms of Service
            {activeTab === 'terms' && (
          ...
          <button
            ...
            className={`pb-3 text-sm font-bold transition-all relative ${
              activeTab === 'privacy' ? 'text-brand' : 'text-slate-500 hover:text-slate-700'
            }`}
          >
            Privacy Policy
            {activeTab === 'privacy' && (
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-1">
            <button className="p-1.5 text-slate-500 hover:bg-slate-200 rounded transition-colors" title="Bold"><Bold size={16} /></button>
            <button className="p-1.5 text-slate-500 hover:bg-slate-200 rounded transition-colors" title="Italic"><Italic size={16} /></button>
            <div className="w-px h-5 bg-slate-300 mx-1"></div>
            <button className="p-1.5 text-slate-500 hover:bg-slate-200 rounded transition-colors" title="Bullet List"><List size={16} /></button>
            <button className="p-1.5 text-slate-500 hover:bg-slate-200 rounded transition-colors" title="Add Link"><LinkIcon size={16} /></button>
          </div>
        ...
        <div className="p-6">
          <textarea
            ...
            className="w-full min-h-[400px] text-sm text-slate-700 leading-relaxed bg-transparent border-0 focus:ring-0 resize-none outline-none custom-scrollbar"
          />
        </div>
